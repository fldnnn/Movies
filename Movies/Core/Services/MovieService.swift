...
final class MovieService {
    ...
    func fetchPopularMovies(page: Int, completion: @escaping (Result<MovieResults, Error>) -> Void) {
        guard let popularMovieUrl = popularMovieUrl, var urlComponents = URLComponents(string: popularMovieUrl), let token = KeychainManager.load(key: .token) else { return }
